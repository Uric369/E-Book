package com.example.microservice.utils.MsgUtils;
...
public class MsgUtil {
    ...
    public static final int ACCOUNT_DISABLED_ERROR = -102;
    public static final String ACCOUNT_DISABLED_ERROR_MSG = "您的账号已被禁用";
